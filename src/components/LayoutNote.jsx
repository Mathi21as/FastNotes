...
const LayoutNote = ({index, executeLocalSetItem, delNote, count, setCountNotes, hideNotesFlag}) => {
  ...
  const open_Note = () => {
    if( openNote )
      return <OpenNote index={index} executeLocalSetItem={executeLocalSetItem} delNote={delNote} count={count} setCountNotes={setCountNotes} uuidv4={uuidv4} openNote={openNote} setOpenNote={setOpenNote}/>
  }
